      ...
      <main>
        ...
        <section id="lokasi" className="px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="mx-auto grid max-w-[80rem] overflow-hidden rounded-[2rem] bg-[#dff0ea] lg:min-h-[38rem] lg:grid-cols-[0.8fr_1.2fr]">
            <div className="relative min-h-[22rem] overflow-hidden"><Image src="/clinic/alfarhain-kok-lanas.webp" alt="Pusat Rawatan Al-Farhain di Kok Lanas" fill unoptimized sizes="(max-width: 1024px) 100vw, 50vw" className="object-cover object-top lg:origin-top lg:scale-[1.35]" /></div>
